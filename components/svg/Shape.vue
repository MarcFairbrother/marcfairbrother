<template>
  <svg xmlns="http://www.w3.org/2000/svg" id="shape" viewBox="0 0 100 100">
    <path
      d="M20 75 70 30 75 60 30 20 32 80 90 85 10 35 90 20 60 10 50 95 90 55 5 60 15 15"
      id="path"
      fill="none"
    ...
    >
      <animate
        attributeName="d"
        id="animation"
        values="M20 75 70 30 75 60 30 20 32 80 90 85 10 35 90 20 60 10 50 95 90 55 5 60 15 15"
        dur="3s"
        begin="indefinite"
      />
    </path>
